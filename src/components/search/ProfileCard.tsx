  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="w-12 h-12 rounded-full bg-navy-100 flex items-center justify-center text-navy-800 font-bold text-lg flex-shrink-0 overflow-hidden">
          {profile.avatar_url ? (
        ...
        <div className="flex-1 min-w-0">
          ...
          {profile.help_offer && (
            <div className="flex items-center gap-1 mt-1.5">
              ...
              <p className="text-slate-600 text-xs line-clamp-1">{profile.help_offer}</p>
            </div>
          )}
        </div>
      </div>
